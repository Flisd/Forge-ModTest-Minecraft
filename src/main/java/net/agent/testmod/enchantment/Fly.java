...
public class Fly extends Enchantment {
    ...
    private static final ChatFormatting[] COLORS = {
            ChatFormatting.GRAY, ChatFormatting.WHITE, ChatFormatting.GRAY
    };
    ...
    public Component getFullname(int level) {
        String name = ">>> Fly Fly Fly <<<";
        MutableComponent coloredName = Component.literal("");

        long time = System.currentTimeMillis() / 120; // Adjust the speed of color change
