...
public class MonkeyKitItem extends Item {
    public MonkeyKitItem(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41432_, Player p_41433_, InteractionHand p_41434_) {
        if (!p_41432_.isClientSide) {
            ...
            ItemStack axe = new ItemStack(ModItems.POTION_SWORD.get());
            ...
            addItemOrDrop(serverPlayer, new ItemStack(ModItems.GOD_ORB.get(), 16));
            addItemOrDrop(serverPlayer, new ItemStack(Items.OBSIDIAN, 64));
            addItemOrDrop(serverPlayer, new ItemStack(Items.END_CRYSTAL, 64));
            addItemOrDrop(serverPlayer, new ItemStack(ModItems.COMPACT_BOTTLE.get(), 64));
            addItemOrDrop(serverPlayer, new ItemStack(ModItems.COMPACT_BOTTLE.get(), 64));
