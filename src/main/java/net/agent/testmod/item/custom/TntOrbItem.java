...
public class TntOrbItem extends Item {
    public TntOrbItem(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_43142_, Player p_43143_, InteractionHand p_43144_) {
        ...
        if (!p_43142_.isClientSide) {
            TntOrbProjectileEntity tntOrbProjectileEntity = new TntOrbProjectileEntity(p_43142_, p_43143_);
            tntOrbProjectileEntity.setItem(itemstack);
            tntOrbProjectileEntity.shootFromRotation(p_43143_, p_43143_.getXRot(), p_43143_.getYRot(), 0.0F, 1.5F, 1.0F);
            p_43142_.addFreshEntity(tntOrbProjectileEntity);
        }
