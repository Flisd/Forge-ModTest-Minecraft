...
public class WaterLavaOrb extends Item {
    public WaterLavaOrb(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            WaterLavaProjectileEntity godOrbProjectileEntity = new WaterLavaProjectileEntity(level, player);
