...
import net.agent.testmod.entity.custom.TunnelOrbProjectileEntity;
...
public class TunnelOrbItem extends Item {
    public TunnelOrbItem(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            TunnelOrbProjectileEntity godOrbProjectileEntity = new TunnelOrbProjectileEntity(level, player);
